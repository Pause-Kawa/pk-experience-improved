# Remove the hanging tag to release the player
tag @s remove PK_player_hanging
# Kill the relative hanging point
kill @e[type=area_effect_cloud,tag=PK_magnet_hook_hanging_point,tag=relative_player_reached,sort=nearest,limit=1]
