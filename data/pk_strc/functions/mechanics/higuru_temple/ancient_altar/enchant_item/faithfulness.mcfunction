...
data modify storage temp Items[1].tag.pkFaithfulness set value 1b
data modify storage temp Items[1].tag.display.Lore prepend value '{"text":"Faithfulness","color":"yellow","italic":false}'
