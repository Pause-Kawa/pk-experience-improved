# Spawners
execute unless score %PK_param_dev_mode value matches 2.. if entity @s[tag=PK_spawner,tag=!init] run function pk_strc:mechanics/steamer_strays_wellbore/spawners/init
