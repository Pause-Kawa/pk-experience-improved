...
data modify storage temp Items[1].tag.pkSafeguardInstinct set value 1b
data modify storage temp Items[1].tag.display.Lore prepend value '{"text":"Safeguard Instinct","color":"yellow","italic":false}'
