...
scoreboard players operation %PK_RNG_2 value = %PK_randomizer_seed value
scoreboard players operation %PK_RNG_2 value /= %PK_const_100 value
scoreboard players operation %PK_RNG_2 value %= %PK_randomizer_max value