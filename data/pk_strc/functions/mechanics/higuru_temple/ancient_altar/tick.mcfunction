...
execute if entity @s[tag=!PK_triggered] at @s if block ~ ~1 ~ #minecraft:buttons[powered=true] run function pk_strc:mechanics/higuru_temple/ancient_altar/ancient_altar_check_content
