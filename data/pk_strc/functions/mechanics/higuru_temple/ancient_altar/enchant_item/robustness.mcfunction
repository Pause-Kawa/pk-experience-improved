...
data modify storage temp Items[1].tag.pkRobustness set value 1b
data modify storage temp Items[1].tag.display.Lore prepend value '{"text":"Robustness","color":"yellow","italic":false}'
